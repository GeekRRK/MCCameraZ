...
+ (void)requestShootidWithMOE:(NSDictionary<NSString *, id> * _Nonnull)dict sucessBlock:(void (^ _Nonnull)(NSString * _Nonnull))sucessBlock failureBlock:(void (^ _Nonnull)(NSString * _Nonnull, NSString * _Nonnull))failureBlock;
+ (void)uploadWithShootidWithShootid:(NSString * _Nonnull)shootid datas:(NSArray<NSData *> * _Nonnull)datas progressBlock:(void (^ _Nonnull)(double))progressBlock successBlock:(void (^ _Nonnull)(NSString * _Nonnull))successBlock failureBlock:(void (^ _Nonnull)(NSString * _Nonnull, NSString * _Nonnull))failureBlock;
...
@class MCCameraPreviewView;

SWIFT_CLASS("_TtC8MCCamera8MCCamera")
@interface MCCamera : NSObject
@property (nonatomic, weak) id <MCCameraDelegate> _Nullable delegate;
- (void)startRunning;
- (void)stopRunning;
- (void)refocus;
- (void)setupWithPreview:(MCCameraPreviewView * _Nonnull)preview successBlock:(void (^ _Nonnull)(void))successBlock failureBlock:(void (^ _Nonnull)(void))failureBlock;
- (void)setVideoOrientationWithIsUpsideDown:(BOOL)isUpsideDown;
- (void)captureForLight:(NSInteger)light;
...
SWIFT_CLASS("_TtC8MCCamera19MCCameraPreviewView")
...
@protocol MCMOEDelegate;

SWIFT_CLASS("_TtC8MCCamera5MCMOE")
@interface MCMOE : NSObject
@property (nonatomic, weak) id <MCMOEDelegate> _Nullable delegate;
- (void)startScan;
- (void)reset;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface MCMOE (SWIFT_EXTENSION(MCCamera)) <CBCentralManagerDelegate, CBPeripheralDelegate>
- (void)centralManagerDidUpdateState:(CBCentralManager * _Nonnull)central;
- (void)centralManager:(CBCentralManager * _Nonnull)central didDiscoverPeripheral:(CBPeripheral * _Nonnull)peripheral advertisementData:(NSDictionary<NSString *, id> * _Nonnull)advertisementData RSSI:(NSNumber * _Nonnull)RSSI;
- (void)centralManager:(CBCentralManager * _Nonnull)central didConnectPeripheral:(CBPeripheral * _Nonnull)peripheral;
- (void)centralManager:(CBCentralManager * _Nonnull)central didFailToConnectPeripheral:(CBPeripheral * _Nonnull)peripheral error:(NSError * _Nullable)error;
...
SWIFT_PROTOCOL("_TtP8MCCamera13MCMOEDelegate_")
@protocol MCMOEDelegate
- (void)resetFail;
- (void)resetting;
- (void)resetSuccess;
- (void)testMoistOilFail;
- (void)testElasticityFail;
- (void)testSuccessWithMoistInt:(NSInteger)moistInt oilInt:(NSInteger)oilInt elasticityInt:(NSInteger)elasticityInt;
@end
